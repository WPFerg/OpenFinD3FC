        ...
        _createClass(WindowCreationService, [{
            ...
            value: function createMainWindow(name, isCompact, successCb) {
                ...
                var windowCreatedCb = function windowCreatedCb(newWindow) {
                    ...
                    _this6.storeService.open(newWindow.name).openWindow();
...
(function () {
    ...
    var BITFLUX_STOCK_AMOUNT = 1200;
    var BITFLUX_INITIAL_PROPORTION = 16 * 7 / BITFLUX_STOCK_AMOUNT; // ~4 months
    var TEAROUT_WINDOW_OFFSET = [268, 65];
    var TEAROUT_WINDOW_OFFSET_COMPACT = [218, 47];
